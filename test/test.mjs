...
let result = new TestUnit()
  .section("lambdacommon:identifier", section => {
    section.add("Identifier(String identifier)", () => new Identifier("lambdacommon:identifier").toString(), "lambdacommon:identifier");
    section.add("Identifier(String identifier, String sub_path)", 
      () => new Identifier("lambdacommon:identifier", "yay").toString(), "lambdacommon:identifier/yay");
    section.add("Identifier.sub(String path)", () => ID_TEST.sub("yay").toString(), "lambdacommon:test/yay");
